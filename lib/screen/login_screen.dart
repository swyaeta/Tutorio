        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              style: TextStyle(color: Color.fromARGB(255, 37, 121, 239), fontSize: 13),
            ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Center(
                            child: Text(
                              'Log in to continue your SAT journey.',
                          ...
                          _buildRectangularSocialButton(
                            ...
                            color: const Color.fromARGB(255, 62, 78, 203),
  ...
  Widget _buildDivider() => const Row(
        children: [
          ...
          Padding(
            ...
            child: Text('or continue with', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 14)),
          ),
          Expanded(child: Divider(color: Color(0xFFE2E8F0), thickness: 1)),
        ],
      );
